                ...
                <div class="comments__row">
                    <div class="d-flex flex-grow-1">
                        <div class="comments__avatar">
                            <img src="{{asset('images/users') . '/' . $comment->user->profile }}" class="comments__img" height="50">
                        </div>
                    ...
                    <a href="#comments" onclick="setReplayValue({{ $comment->id }})" class="btn btn--blue btn--shadow-blue btn--comments-reply">ارسال پاسخ</a>
                </div>
            </div>
