    ...
    <div class="container container--responsive container--white">
        <div class="c-header__row ">
            ...
            <div class="c-header__left">
                ...
                @else
                <div class="dropdown-select wide" id="dropdown-user" onclick="toggleUserDropdown()" tabindex="0" style="margin-right: 15px;">
                    ...
                    <div class="list">
                            <ul>
                                ...
                                <li class="option " data-value="0" data-display-text="" onclick="logoutUser()">خروج</li>
                            </ul>
